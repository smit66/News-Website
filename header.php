        ...
        <div class="container">
                    ...
                    ?>
                        ...
                        <div class="navbar">
                            ...
                            <button class="btn btn-secondary " id="mo1" type="button">
                                <a  href='http://localhost/second'>Home </a></button>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<a  href='category.php?cid={$row['category_id']}'>{$row['category_name']} </a><br>";
                                    } ?>
                                </div>
                            </div>
            ...
            <div class="my">
                <form class="search-post" action="search.php" method="GET">
                    <div class="input-group" class="searching">
                        <input type="text" name="search" class="form-control" placeholder="Search ..... " id="speechToText">
                    ...
                    <div  class="assi">
                    <i class="fa fa-microphone" aria-hidden="true" onclick="record()" color="white"></i>
                    </div>
                </form>
            </div>
        </div>
